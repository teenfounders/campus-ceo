...
const page = (props: Props) => {
  return (
    <div className="bg-white  px-5 mx-5 rounded-[40px] -mt-[35px] max-w-full py-5 mb-10">
      <div className="mt-5 flex flex-col gap-10 w-full h-full overflow-hidden ">
       ...
       <Revel>
          ...
          <h1 className=" text-[32px] text-start text-[#1A1C22] font-cabinet  font font-[700] leading-[50.28px] tracking-[-3%] font-['Cabinet Grotesk']  mt-5 mb-[30px] font-archivo  font-[400] text-[28px] leading-[3rem]  tracking-[-0.1%] text-center text-[#2D2323] ">
 
            Our Campus Ambassador Awards program recognizes and rewards
            exceptional student leaders who’ve made significant contributions to
            their campus communities and beyond
          </h1>
       </Revel>
        </div>
        <div className="mt-[60px]    mx-auto  w-full grid grid-cols-6 lg:grid-cols-9 lg:grid-rows-2 gap-3 md:gap-10 mb-[20px]  px-10">
         ...
         <Revel>
          ...
          <Revel>
            ...
            <p className="  w-full font-archivo font-[400] text-[22px] leading-[43px] tracking-[-0.1%]">
              Awards fuel the growth of ambassadors, encouraging them to achieve
              greatness in their respective fields.{" "}
            </p>
          </Revel>
          </div>
          <div className="lg:row-span-1 py-10 px-10 bg-[#4A3E3E] items-center justify-center col-span-6  flex flex-col gap-3 text-[#FFFFFF]">
         <Revel>
             <p className="font-cabinet font-[500] text-[26px]  leading-[50px] tracking-[-0.5%]">
              Recognizing the dedication and achievements of exceptional campus
              ambassador leaders. Witness stars being born and dreams coming
              true!
            </p>
          </Revel>
          </div>
     ...
     <Revel>
          <div className="font-archivo max-w-[723px]  font-[500] text-2xl tracking-[-0.5%] items-center justify-center flex flex-col gap-5 text-center">
            ...
            <p className="leading-[35.5px] font-archivo font-[400] text-[22px] tracking-[-0.1%] text-center">
              Hey you, yes YOU! Do you have what it takes to be an awe-inspiring
              campus ambassador? Can you rally like a BOSS? Then click below and
        ...
        <div className="flex my-10 items-center justify-center w-full font-cabinet font-[800] text-5xl tracking-[-0.1%]">
          Award Categories
        </div>
          </Revel> 
        ...
        <div className="  h-full relative mx-10">
          <CommunityCard />
        </div>
        </Revel>
...
<Revel>
      <div className="grid grid-cols-1 lg:grid-cols-6 items-center justify-center px-10 pb-[20px] mx-10 gap-10">

  <div className="col-span-1 lg:col-span-3">
    <div className="min-h-max">
      <EmpoweredCard className="border-[1px]  border-[#D7D7D7]" image1={img1} image2={star1} text="4,7" description="Average review on Capterra, independent review site" />
    </div>
  </div>
  ...
  <div className="col-span-1 lg:col-span-3">
    <div className="">
      <EmpoweredCard text="98,9%" className="border-[1px]  border-[#D7D7D7]"  image1={img2} emoji="😃&nbsp;🤩" description="Average rating based on 1500+ support conversations" />
    </div>
  </div>
</div>
</Revel>
